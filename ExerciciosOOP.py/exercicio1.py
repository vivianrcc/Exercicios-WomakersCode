...
class BancoAbstract(ABC):
    @abstractmethod
    def contacorrente(self):
        pass
    
    @abstractmethod
    def operaçaodeposito(self):
        pass
    @abstractmethod
    def operaçaosaque(self):
        pass
#Criando a classe banco
    
class Banco(BancoAbstract):
    def __init__(self ,nome,telefone,renda_mensal,cadrastro):
        self.nome= nome 
        self.telefone= telefone
        self.renda_mensal= renda_mensal
        self.cadrastro= cadrastro
    
class BancoDelas(Banco):
